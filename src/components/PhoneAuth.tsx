        ...
        <div className="auth-card">
          ...
          {step === "done" && (
            <>
              ...
              <a className="auth-btn center" href={`/onboarding?lang=${lang}`}>
                {t.toChat}
              </a>
            </>
          )}
